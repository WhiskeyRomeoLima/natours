...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  console.log('user: ', req.body.user) // req.body.user:  undefined
  console.log('req.body.email: ', req.body.email) // req.body.email:  
  //url =  POST /api/v1/users/forgotPassword 404 73.106 ms - 399
  // from GlobalError: "message": "There is no user with that email address."
